    ...
    Client: Send + Sync + 'static,
{
    ...
    /// Query state root at specific block or current block
    fn query_state_root_at(&self, at: Option<Block::Hash>) -> FutureResult<Block::Hash>;

    /// Query extrinsics root at specific block or current block
    ...
    Client: Send + Sync + 'static,
{
    ...
    fn query_state_root_at(&self, at: Option<Block::Hash>) -> FutureResult<Block::Hash> {
        self.backend.query_state_root_at(at)
    }

    fn query_extrinsics_root_at(&self, at: Option<Block::Hash>) -> FutureResult<Block::Hash> {
        self.backend.query_extrinsics_root_at(at)
    }
