...
pub trait StateApi<Hash> {
    ...
    /// Query starte root for specific block or current block
    #[rpc(name = "state_queryStateRoot")]
    fn query_state_root_at(&self, at: Option<Hash>) -> FutureResult<Hash>;

    /// Query extrinsics root for specific block or current block
    #[rpc(name = "state_queryExtrinsicsRoot")]
    fn query_extrinsics_root_at(&self, at: Option<Hash>) -> FutureResult<Hash>;
