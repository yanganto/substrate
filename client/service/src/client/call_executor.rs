    ...
    Block: BlockT,
{
    ...
    fn call(
        ...
        println!("DEBUG(call): changes tries is created");
        if let Some(s) = changes_trie.clone() {
            println!("DEBUG(call): {:?}", s.zero);
        } else {
            println!("DEUBG(call): None");
        }
        ...
        ExecutionManager<EM>: Clone,
    {
        ...
        println!("DEBUG(contextual_call): changes tries is created");
        if let Some(s) = changes_trie_state.clone() {
            println!("DEBUG(contextual_call): {:?}", s.zero);
        } else {
            println!("DEUBG(contextual_call): None");
        }
